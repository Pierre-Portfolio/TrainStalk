...
doc=open("C://Users\danyp\Documents\GitHub\DataMining\Site\src\Onthologies\Data\Gare\data.json")
context=open("C://Users\danyp\Documents\GitHub\DataMining\Site\src\Onthologies\Data\Gare\context.json")

compacted = jsonld.compact(json.dumps(doc.readlines()),json.dumps(context.readlines()))
"""
